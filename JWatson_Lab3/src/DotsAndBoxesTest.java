...
public class DotsAndBoxesTest extends TestCase {
    ...
    @Test
    public void testAnyMoves() {/////////////////////////////////////////////////////////////
        DotsAndBoxes d = new DotsAndBoxes(2, 2);

        d.drawLine(1, 0, 0, 1, 0);

        Assert.assertEquals(true, d.anyMovesLeft());

        d.drawLine(1, 0, 1, 1, 1);
        d.drawLine(1, 0, 0, 0, 1);
        d.drawLine(1, 1, 1, 1, 1);




        Assert.assertEquals(false, d.anyMovesLeft());
    }
