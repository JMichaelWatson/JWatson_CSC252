...
//        byte[] decompTemp = compressor.decompress(huffTree,4,temp);
...
//        HashMap<String, Double> freqChar = new HashMap<String, Double>();
//        String[] Keys = new String[256];
//        int x= 0;
//        for(int count = -128; count <= 127; count++ ){
//            Keys[x] = count+"";
//            x++;
//        }
...
//            byte[] decompBytes =  compressor.decompress(huffTree, bytes.length, bytes);
//            Files.write(Paths.get("decompressed.txt"), decompBytes);
//            System.out.println("Decompressed...");
//            System.out.println("Compressing....");
//            byte[] compBytes = compressor.compress(huffTree,Files.readAllBytes(Paths.get("Decompressed.txt")));
//            Files.write(Paths.get("compressed.txt"), compBytes);
